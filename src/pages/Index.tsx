...
const services = [
  {
    ...
    path: 'https://www.theconverseai.com/services/ai-strategy-readiness-audit',
  },
  {
    icon: Cpu,
    ...
    path: 'https://www.theconverseai.com/services/agentic-systems-process-automation',
  },
  {
    icon: Mic,
    ...
    path: 'https://www.theconverseai.com/services/ai-voice-agents',
  },
  {
    icon: Bot,
    ...
    path: 'https://www.theconverseai.com/services/custom-ai-agent-development',
  },
  {
    icon: Network,
    ...
    path: 'https://www.theconverseai.com/services/ai-integration-services',
  },
  {
    icon: FileText,
    ...
    path: 'https://www.theconverseai.com/services/document-knowledge-intelligence',
  },
  {
    icon: TrendingUp,
    ...
    path: 'https://www.theconverseai.com/services/sales-intelligence-outreach',
  },
]
    ...
    <>
      <Helmet>
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "sameAs": [
            "https://linkedin.com/company/theconverseai",
            "https://youtube.com/@theconverseai",
            "https://instagram.com/theconverseai/",
            "https://facebook.com/61564130560658/"
          ],
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "potentialAction": {
            ...
            "target": {
              "@type": "EntryPoint",
              "urlTemplate": "https://www.theconverseai.com/?s={search_term_string}"
            },
      ...
      <div>
        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
          ...
          <div className="floating-orb w-80 h-80 bg-violet -top-20 right-0" />
          <div className="floating-orb w-64 h-64 bg-accent bottom-20 left-1/3" />
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                >
                  Get a Free AI Opportunity Audit <ArrowRight className="w-4 h-4" />
                </a>
        ...
        <section className="py-24 bg-surface relative overflow-hidden">
          <div className="floating-orb w-80 h-80 bg-accent bottom-0 -right-40" />
          <div className="floating-orb w-64 h-64 bg-primary -top-32 left-1/4" />
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              {services.map((service, i) => (
                ...
                >
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-accent/20 to-violet/10 flex items-center justify-center mb-5 group-hover:from-accent/30 transition-all">
            ...
            >
              ...
              <a
                ...
                className="btn-gradient text-base !py-3.5 !px-8 inline-flex items-center gap-2"
              >
                Book a Free AI Opportunity Audit <ArrowRight className="w-4 h-4" />
              </a>
            </motion.div>
          </div>
        </section>
        ...
        {/* Why ConverseAI */}
        <section className="py-24 bg-surface relative overflow-hidden">
          <div className="floating-orb w-72 h-72 bg-primary top-0 right-0" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              >
                {[
                  ...
                  <div key={item.title} className="flex gap-4">
                    <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-primary/10 to-violet/10 flex items-center justify-center shrink-0">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-muted">Head of Customer Success, TechFlow Inc.</p>
                </div>
              </motion.div>
            </div>
          </div>
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {industries.map((industry) => (
                <motion.span
                  ...
                  viewport={{ once: true }}
                  className="px-5 py-2.5 bg-white border border-purple-100 rounded-full text-sm font-medium text-foreground hover:border-primary hover:text-primary transition-colors cursor-default"
                >
                  {industry}
                </motion.span>
              ))}
        ...
        <section className="py-24 relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-primary via-violet to-pink-500" />
          <div className="floating-orb w-96 h-96 bg-white/20 -top-48 -right-48" />
